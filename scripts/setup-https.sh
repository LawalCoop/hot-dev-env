...
echo ""
echo "   Main services (.hotosm.test - requires /etc/hosts):"
...
echo ""
echo "   Infrastructure (.localhost - works automatically):"
echo -e "   ${GREEN}https://minio.localhost${NC}          - S3 storage console"
echo -e "   ${GREEN}https://traefik.localhost/traefik${NC} - Traefik dashboard"
echo ""
echo "   ${YELLOW}Note: *.localhost resolves automatically (RFC 6761)${NC}"
echo "   ${YELLOW}      *.hotosm.test requires /etc/hosts configuration${NC}"
echo ""
